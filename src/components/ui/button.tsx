	...
	"cursor-pointer inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
	{
		variants: {
			variant: {
				...
				shine:
					"text-primary-foreground animate-shine bg-linear-to-r from-body-font via-body-font/60 to-body-font bg-size-[400%_100%] ",
				gooeyRight:
				...
				linkHover1:
					"relative after:absolute after:bg-secondary after:bottom-2 after:h-[1.5px] after:w-2/3 after:origin-bottom-left after:scale-x-100 hover:after:origin-bottom-right hover:after:scale-x-0 after:transition-transform after:ease-in-out after:duration-300",
				linkHover2:
					"relative after:absolute after:bg-secondary/80 after:bottom-2 after:h-[1.5px] after:w-2/3 after:origin-bottom-right after:scale-x-0 hover:after:origin-bottom-left hover:after:scale-x-100 after:transition-transform after:ease-in-out after:duration-300",
			},
			size: {
		...
		return (
			...
			>
				...
				{Icon && iconPlacement === "right" && (
					<div className="w-0 translate-x-full pl-0 opacity-0 transition-all duration-300 ease-in-out group-hover:w-5 group-hover:translate-x-0 group-hover:pl-2 group-hover:opacity-100">
						<Icon />
					</div>
				)}
			</Comp>
